...
export default function Education() {
  ...
  return (
    <section id="education" className="py-16 md:py-24 px-8 md:px-16 lg:px-24 relative bg-gradient-to-b from-white via-slate-50 to-white dark:from-black dark:via-slate-950 dark:to-black">
